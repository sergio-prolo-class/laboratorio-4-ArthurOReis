...
public class Administracao extends Estagiario {
    ...
    public Administracao(String nome, String sobrenome, String cpf, Queue<String> emails, String dataInicioContrato, double salarioBrutoMensal, int cargaHorariaSemanal, String nomeDaInstituicaoDeEnsino, boolean obrigatorio, CLT orientador, String setorAtual, String descricaoTarefaPrincipal){
